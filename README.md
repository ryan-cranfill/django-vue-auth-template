# Django Vue Template ✌️ 🐍 + Auth
A mashup of [django-vue-template](https://github.com/gtalarico/django-vue-template) and [vue-django-rest-auth](https://github.com/jakemcdermott/vue-django-rest-auth).
The goal is to provide a starting point for an app that uses django for an API and auth server and Vue for a frontend.
